...
public class MainActivity extends AppCompatActivity implements
    ...
    private void showCharging(boolean toggle) {
        mChargingImageView.setImageDrawable(getDrawable(toggle ? R.drawable.ic_power_pink_80px : R.drawable.ic_power_grey_80px));
    }
