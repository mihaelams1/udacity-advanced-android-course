...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_LOADER = 42;
    ...
    private void loadWeatherData() {
        ...
        Loader<String[]> loader = manager.getLoader(WEATHER_LOADER);

        if (loader == null) {
            manager.initLoader(WEATHER_LOADER, bundle, this);
        } else {
            manager.restartLoader(WEATHER_LOADER, bundle, this);
        }
    }
