...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI("com.example.android.sunshine", WeatherContract.PATH_WEATHER, CODE_WEATHER);
        matcher.addURI("com.example.android.sunshine", WeatherContract.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                cursor = mOpenHelper.getReadableDatabase().query(WeatherContract.WeatherEntry.TABLE_NAME, projection,
