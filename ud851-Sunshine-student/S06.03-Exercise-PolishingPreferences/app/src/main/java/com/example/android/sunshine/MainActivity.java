...
import static com.example.android.sunshine.data.SunshinePreferences.resetLocationCoordinates;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private void openLocationInMap() {
        Uri geoLocation = Uri.parse("geo:0,0?q=" + getPreferredWeatherLocation(this));
